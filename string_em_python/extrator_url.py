...
if moeda_origem == "dolar" and moeda_destino == "real":
    ...
    print(f"${int(valor_quantidade):.2f} dolares é igual a R${valor_conversao:.2f} reais.")
elif moeda_origem == "real" and moeda_destino == "dolar":
    valor_conversao = int(valor_quantidade) * valor_dolar
    print(f"R${int(valor_quantidade):.2f} reais é igual a ${valor_conversao:.2f} dolares.")
else:
...
# print(extrator_url == extrator_url_1)

# print(extrator_url.__eq__(extrator_url_1))
